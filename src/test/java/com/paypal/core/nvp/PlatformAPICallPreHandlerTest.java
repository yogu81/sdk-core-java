...
//				"payload", "servicename", "method", signatureCredential, null);
...
//		PlatformAPICallPreHandler platformApiCaller = new PlatformAPICallPreHandler(
//				"payload", "servicename", "method", certificateCredential, null);
//		Map<String, String> header = platformApiCaller.getHeaderMap();
...
//
//	@Test(dataProvider = "configParams", dataProviderClass = com.paypal.core.DataProviderClass.class)
//	public void setGetSDKVersionAndNameTest(ConfigManager conf)
//			throws Exception {
//		PlatformAPICallPreHandler platformApiCaller = new PlatformAPICallPreHandler(
//				"payload", "servicename", "method",
//				"jb-us-seller_api1.paypal.com", "accessToken", "tokenSecret",
