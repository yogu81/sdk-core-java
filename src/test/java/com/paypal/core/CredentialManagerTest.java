...
public class CredentialManagerTest {
	...
	// @Test(dataProvider = "configParams", dataProviderClass =
	...
	@Test(expectedExceptions = MissingCredentialException.class, dataProvider = "configParams", dataProviderClass = DataProviderClass.class)
