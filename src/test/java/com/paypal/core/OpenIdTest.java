...
public class OpenIdTest {
	...
	public void testAuthorizationURL() {
		...
		Assert.assertEquals(
				redirectURL,
				"https://www.paypal.com/webapps/auth/protocol/openidconnect/v1/authorize?client_id=ANdfsalkoiarT&response_type=code&scope=openid+profile&redirect_urihttp%3A%2F%2Fgoogle.com");
	}
}
