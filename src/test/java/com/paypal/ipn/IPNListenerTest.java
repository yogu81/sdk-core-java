...
public class IPNListenerTest {
	...
	public void getIpnParamValueMapTest(ConfigManager config) throws IOException{
		ipnmsg=new IPNMessage(ipnMap);
		Map<String,String> map = ipnmsg.getIpnParamValueMap();
		Assert.assertNotNull(map);
	}
	
	@Test
	public void getIpnParamValueTest(){
		String feesPayer = ipnmsg.getIpnParamValue("fees_payer");
		Assert.assertEquals("EACHRECEIVER", feesPayer);
	}
	
	@Test
	public void isIpnVerifiedTest(){
		Assert.assertEquals(false, ipnmsg.isIpnVerified());
	}
